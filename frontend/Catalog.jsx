...
const catalogData = [
  ...
  { icon: "text", type: "text", title: "RAG Architecture Notes", desc: "Technical notes on retrieval-augmented generation, vector databases, and embedding strategies.", author: "You", comments: 3, queries: 47, time: "3 days ago", tags: ["tech", "AI", "RAG"] },
    ...
    <Page id="catalog">
      <div style={{ padding: "24px 20px 60px", maxWidth: 920, margin: "0 auto", width: "100%" }}>
        <div className="catalog-head">
          ...
          <p className="mono">6 sources available</p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="cart-body">
                    ...
                    <div className="cart-tags">{c.tags.map((t) => <span className="mini-tag" key={t}>{t}</span>)}</div>
                  </div>
                </motion.div>
              );
            })}
